    ...
    <>
      ...
      <section className="relative mt-16 h-[34vh] min-h-[240px] flex items-center justify-center overflow-hidden">
        <Image
          ...
          alt="Noticias de Autos MotorWelt"
          fill
          sizes="100vw"
            ...
            <div className="grid gap-6 md:grid-cols-[1fr_auto] md:items-center">
              <div>
                ...
                <h4 className="mt-3 text-2xl md:text-3xl font-extrabold text-white">
                  Recibe lo mejor de Autos en tu correo
                </h4>
              ...
              >
                <label htmlFor="newsletter-autos-email" className="sr-only">
                  Tu correo electrónico
                </label>
                <input
                  id="newsletter-autos-email"
                  type="email"
