...
function SidebarArticleCard({ item }: { item: SidebarArticle }) {
  return (
    <Link
      href={item.href || `/deportes/${item.slug}`}
...
export const getServerSideProps: GetServerSideProps = async ({
  ...
  return {
    props: {
      ...
      article,
      latestArticles,
      deportesSettings: sanitizeDeportesSettings(globalSlugAdsRaw),
      sectionHeroImages,
    },
  };
};
