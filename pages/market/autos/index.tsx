...
const featuredCars: Car[] = [
  {
    ...
    subtitle: "Stage 2 • DSG • Listo para track day",
    year: 2017,
    price: "$420,000 MXN",
    km: "65,000 km",
    location: "CDMX",
    tags: ["GTI", "Turbo", "Track day"],
  },
  {
    id: "2",
    title: "BMW M2 Competition",
    subtitle: "S55 • DCT • Servicios en agencia",
    year: 2019,
    price: "$980,000 MXN",
    km: "38,000 km",
    location: "Guadalajara, Jal.",
    tags: ["M Power", "RWD", "Coupé"],
  },
  {
    id: "3",
    title: "Mazda MX-5 ND",
    subtitle: "Manual • Convertible • Ideal para fin de semana",
    year: 2016,
    price: "$390,000 MXN",
    km: "52,000 km",
    location: "Monterrey, N.L.",
    tags: ["Roadster", "Manual", "Ligero"],
  },
];
...
export default function AutosHome() {
  return (
    <>
      <Seo
        title="Autos | MotorWelt Market"
        description="Compra y venta de autos seleccionados por entusiastas, curados por MotorWelt."
      />
          ...
          <section className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="space-y-3">
              ...
              <p className="max-w-xl text-sm text-neutral-400 sm:text-base">
                Una selección cuidada de autos de entusiastas para entusiastas.
                Filtra por marca, año, estilo de manejo o presupuesto y
                encuentra tu próximo proyecto, daily o arma de track.
              </p>
            </div>
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 rounded-xl border border-neutral-800 bg-neutral-950 px-3 py-2.5 text-sm focus-within:border-neutral-500 focus-within:bg-neutral-900 transition">
                  ...
                  <input
                    id="search"
                    type="text"
                    placeholder="Ej. Golf GTI, M2 Competition, MX-5..."
          ...
          <section className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-neutral-500">
                  Curados por el equipo MotorWelt — ejemplo visual, listo para
                  conectar a Sanity.
                </p>
              </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {featuredCars.map((car) => (
                ...
                >
                  {/* Placeholder imagen (luego sustituimos por <Image />) */}
