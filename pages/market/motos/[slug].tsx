...
export default function MotoSlugPage({ listing }: Props) {
  return (
    <>
      <Seo
        title={`${listing.title} | MotorWelt Market`}
        description={listing.subtitle || "Detalle de moto en MotorWelt Market."}
      />
        ...
        <div className="mx-auto max-w-5xl px-4 space-y-8">
          <nav className="text-[11px] text-neutral-400">
            <ol className="flex items-center gap-1">
              ...
              <li>/</li>
              <li>
                <Link href="/market/motos" className="hover:text-neutral-200">
                  Motos
                </Link>
              </li>
              <li>/</li>
